...
DISABLE_STOCK = {"000661","000792","002594","002737","002815","002913","300401","300451","300602","300628","300773","300856","301071","301487","301551","600167"}
def to_jq_code(c): return c+".XSHG" if c.startswith("6") else c+".XSHE"
HS300_CODES_RAW = [
    '000001',
    '000002',
    '000063',
...
def execute_pending_orders(context):
    ...
    for stock, sig_date, sig_close in g.pending_buys:
        ...
        if shares < lot_size:
            shares = lot_size  # force minimum lot
        ...
        # Final safety net
        if shares < lot_size or shares * last_price * 1.001 > cash * 0.95:
            new_pending_buys.append((stock, sig_date, sig_close))
            continue
